package com.leal.spring_auth_keycloak.auth;
...
public class TokenController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
        ...
        var result = rt.postForEntity("http://localhost:8180/realms/test/protocol/openid-connect/token", entity, String.class);
